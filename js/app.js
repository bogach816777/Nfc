(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            if (window.matchMedia("(max-width: 767.98px)").matches) mySwiper.destroy();
        }
        if (document.querySelector(".colect__slider")) {
            var mySwiper2 = new core(".colect__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (window.matchMedia("(max-width: 767.98px)").matches) mySwiper2.destroy();
        }
        if (document.querySelector(".category__slider")) {
            var mySwiper3 = new core(".category__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (window.matchMedia("(max-width: 767.98px)").matches) mySwiper3.destroy();
        }
    }
    window.addEventListener("load", (function(e) {
        initSliders();
    ...
    var x = setInterval((function() {
        ...
        Math.floor(distance / (1e3 * 60 * 60 * 24));
        ...
        document.getElementById("demo5").innerHTML = hours + "h:" + minutes + "m:" + seconds + "s";
        document.getElementById("demo6").innerHTML = hours + "h:" + minutes + "m:" + seconds + "s";
        document.getElementById("demo7").innerHTML = hours + "h:" + minutes + "m:" + seconds + "s";
        if (distance < 0) {
            clearInterval(x);
    ...
    function animatescroll() {
        ...
        function scrollHandler() {
            animatedElements.forEach((element => {
                if (element.getBoundingClientRect().top < window.innerHeight - 10) element.classList.add("slideInUp");
            }));
        }
